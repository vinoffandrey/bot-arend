...
# text = f'	<a href="{link}"> Ссылка</a> на авито \n \
# 	Ваш номер профиля на Авито: <i>{numberAvito}</i> \n \
# 	Ваш идентификатор объявления на Авито: <i>{idAvito}</i> \n \
# 	________________________________________________________ \n \
# 		\n \
# 	Описание: <i>{description}</i> \n \
# 	________________________________________________________ \n \
# 		\n \
# 	Количество комнат: <i>{rooms}</i> \n \
# 	Фотографии недвижимости: {photo} \n \
# 	________________________________________________________ \n \
# 		\n \
# 	Город: <i>{city_arend}</i> \n \
# 	Адрес: <i>{adress}</i> \n \
# 	________________________________________________________ \n \
# 		\n \
# 	Вместимость: <i>{people_arend} человек</i> \n \
# 	Цена за сутки: <i>{cost_arend}</i> \n \
# 	________________________________________________________ \n \
# 		\n \
# 	Минимальный срок аренды: <i>{min_arend}</i> \n \
# 	Максимальный срок аренды: <i>{max_arend}</i> \n \
# 	________________________________________________________ \n \
# 		\n \
# 	Ваши контакты: <i>{contacts}</i>', parse_mode=telegram.ParseMode.HTML)
